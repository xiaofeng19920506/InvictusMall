...
function AddToCartButton({ product, store }: { product: Product; store: Store }) {
          ...
          <div className="p-6">
            ...
            {activeTab === 'overview' && (
              <div className="space-y-6">
                <div>
                  <h3 className="text-xl font-semibold text-gray-900 mb-4">About {store.name}</h3>
                  <p className="text-gray-700 leading-relaxed">{store.description}</p>
                </div>
                
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-2">Store Information</h4>
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-2">Ratings & Reviews</h4>
                    <div className="space-y-2">
                      <div className="flex items-center gap-2">
                        <span className="text-2xl font-bold text-gray-900">{store.rating.toFixed(1)}</span>
                        <div className="flex">
                          {[...Array(5)].map((_, i) => (
                            <span key={i} className={i < Math.floor(store.rating) ? 'text-yellow-400' : 'text-gray-300'}>
                              ⭐
                            </span>
                          ))}
                        </div>
                      </div>
                      <p className="text-sm text-gray-600">Based on {store.reviewCount} reviews</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            {activeTab === 'reviews' && (
              <div className="space-y-4">
                <div className="text-center py-12">
                  ...
                  <p className="text-sm text-gray-500 mt-2">Reviews feature will be implemented in the next update.</p>
                </div>
              </div>
            )}
          </div>
